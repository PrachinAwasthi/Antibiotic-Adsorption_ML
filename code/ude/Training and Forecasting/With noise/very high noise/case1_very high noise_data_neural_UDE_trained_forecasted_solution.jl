...
#savefig("high noise data traied_case1.png")
#savefig("high noise data traied_case1.svg")
...
#savefig("high noise data_trained_tested_case1.png")
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`
...
##train the NN
#define predict function
function extended_predict(θ, X=nn_ude_pred_sol_noisy[:, end], T=testing_tsteps)
...
nn_ude_pred_sol_testing_noisy=extended_predict(p_tested, nn_ude_pred_sol_noisy[:, end], testing_tsteps)

combined_pred = vcat(nn_ude_pred_sol_noisy[1, :], nn_ude_pred_sol_testing_noisy[1, 1:end])
...
#savefig("UDE_trained_tested_case1.png")
...
#savefig("high noise data_UDE_trained_tested_case1.png")

true_missing_terms=p_initial[2].* (combined_pred[:, :])'
Ȳ=true_missing_terms
# compute the neural network guess of the interactions
nn_pred_missing_terms = nn(nn_ude_pred_sol_noisy, p_trained, st)[1]
Ŷ=nn_pred_missing_terms

nn_forecast_missing_terms=nn(nn_ude_pred_sol_testing_noisy, p_tested, st)[1]
...
plot(combined_tsteps, true_missing_terms',seriestype=:scatter, marker=:circle, alpha=0.5, color=:red, label="Actual term",xlabel="Time (min)", ylabel="Desorption Rate (mg/g min)",  labelcolor=:black, title="UDE Missing Term", size=plot_size, left_margin=left_margin, right_margin=right_margin, bottom_margin=bottom_margin, top_margin=top_margin, legend=:bottom, grid=false, markersize=10, xlabelfontsize=18, ylabelfontsize=18, titlefontsize=28, xtickfontsize=18, ytickfontsize=18, legendfontsize=18)
...
savefig("3_very high noise_true missing term_UDE prediction_case1.png")
...
savefig("3_very high  noise data_UDE_trained_tested_case1.png")
