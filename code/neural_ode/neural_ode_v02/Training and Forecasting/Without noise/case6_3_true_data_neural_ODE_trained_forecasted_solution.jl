...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Optimization-ADAM(1000)+ADAM(10000)+LBFGS(2000)~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
###############################################Training####################################################
##load the packages
...
savefig("true data_neural ODE predicted data_case6_3.png")
...
savefig("true data_trained_tested_case6_3.png")
...
savefig("Neural ODE_trained_tested_case6_3.png")
...
plot!(testing_tsteps,  true_sol_testing[1, :] , seriestype=:scatter, marker=:diamond, markersize=7.0, lw=3, color=:red, label="True forecast data")
plot!(testing_tsteps, nnode_pred_sol_testing[1, :],seriestype=:line,  linestyle=:dash,  lw=3,  color=:blue, label="Neural ODE forecast predicted data")
savefig("true data_neural ODE_trained_tested_case6_3.png")