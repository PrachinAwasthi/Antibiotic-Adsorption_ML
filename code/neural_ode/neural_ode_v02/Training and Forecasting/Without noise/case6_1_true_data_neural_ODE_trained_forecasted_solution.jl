...
p_trained=opt_sol.u
nnode_pred_sol= nnode_predict(opt_sol.u)
...
savefig("true data_neural ODE predicted data_case6_1.png")
...
savefig("true data_trained_tested_case6_1.png")
...
p_tested=opt_sol_testing.u
nnode_pred_sol_testing= nnode_predict(opt_sol_testing.u)
...
savefig("Neural ODE_trained_tested_case6_1.png")
...
plot!(testing_tsteps,  true_sol_testing[1, :] , seriestype=:scatter, marker=:diamond, markersize=7.0, lw=3, color=:red, label="True forecast data")
plot!(testing_tsteps, nnode_pred_sol_testing[1, :],seriestype=:line,  linestyle=:dash,  lw=3,  color=:blue, label="Neural ODE forecast predicted data")
savefig("true data_neural ODE_trained_tested_case6_1.png")